...
- (id)initWithConfiguration:(BOOL)useWKWebView {
    ...
    if(self) {
        if(useWKWebView) {
            ...
            [self.wkWebView.scrollView setContentInset:UIEdgeInsetsMake(topInset, 0, 0, 0)];
            [self.wkWebView setFrame:CGRectMake(0, 0, self.wkWebView.frame.width, self.wkWebView.frame.height-topInset)];
